...
class Settings(BaseSettings):
    ...
    LOCATION_ROUTE_BUFFER_KM: float = 50
    LOCATION_RETENTION_DAYS: int = 30
    DISPATCH_PRESENCE_STALE_AFTER_SECONDS: int = 90
    DISPATCH_NEARBY_RADIUS_KM: float = 25.0
    DISPATCH_BASE_FARE: float = 50.0
    DISPATCH_PER_KM_RATE: float = 15.0
    DISPATCH_DISMISSAL_RETENTION_DAYS: int = 7
    DISPATCH_PRESENCE_RETENTION_HOURS: int = 24
